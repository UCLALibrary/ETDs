...
public class ObjectFactory {
    ...
    private final static QName _GetProquestFilersForAllGdToken_QNAME = new QName("http://tempuri.org/", "gdToken");
    ...
    private final static QName _ReturnResultsForProquestFilersMessage_QNAME = new QName("http://schemas.datacontract.org/2004/07/GD.CommServices", "Message");
    ...
    public JAXBElement<String> createGetProquestFilersForAllGdToken(String value) {
        return new JAXBElement<String>(_GetProquestFilersForAllGdToken_QNAME, String.class, GetProquestFilersForAll.class, value);
    }
    ...
    public JAXBElement<String> createGetProquestFilerForProquestIDGdToken(String value) {
        return new JAXBElement<String>(_GetProquestFilersForAllGdToken_QNAME, String.class, GetProquestFilerForProquestID.class, value);
    }
    ...
    public JAXBElement<String> createReturnResultsForProquestFilersMessage(String value) {
        return new JAXBElement<String>(_ReturnResultsForProquestFilersMessage_QNAME, String.class, ReturnResultsForProquestFilers.class, value);
    }
    ...
    public JAXBElement<String> createReturnResultsForProquestFilersByIDMessage(String value) {
        return new JAXBElement<String>(_ReturnResultsForProquestFilersMessage_QNAME, String.class, ReturnResultsForProquestFilersByID.class, value);
    }
