...
public class GradServiceClient
{
  ...
  public static void main( String[] args )
  {
    ...
    try
    {
      ...
      iProquestFilerService = proquestFilerService.getWsHttpEndpoint();
      ...
      result =
          iProquestFilerService.getProquestFilerForProquestID( args[ 0 ],
                                                               args[ 1 ] );
      System.out.println( "pub date = " + FORMAT.format( result.getProquestFiler().getValue()
                                         .getFileDate().getValue()
    ...
    throws Exception
  {
    ...
    List<CredentialProvider> credList =
  ...
  {
    List serverCertList =
      CertUtils.getCertificate( serverKeyStore, serverKeyStorePwd,
                                serverKeyAlias, "JKS" );
    ...
    final X509Certificate serverCert =
      ( serverCertList != null && serverCertList.size() > 0 ) ?
      ( X509Certificate ) serverCertList.get( 0 ): null;
